...
// import { useState } from "react";
// import { useRouter } from "next/navigation";
// import { useAuth } from "@/lib/auth-store";       // ✅ use hook, not plain function
// import { Mail, Lock, Eye, EyeOff } from "lucide-react";
// import { Button } from "@/components/ui/button";
// import { Input }  from "@/components/ui/input";
// import { Label }  from "@/components/ui/label";
...
// export function LoginForm({ onSwitchToRegister, onSwitchToForgotPassword }: Props) {
//   const { login, isLoading, error } = useAuth();   // ✅ pull state from store
//   const router = useRouter();
...
//     // ✅ pass rememberMe — store decides localStorage vs sessionStorage
//     const ok = await login(email, password, rememberMe);
//     if (ok) router.push("/dashboard");
//   }

//   return (
//     <div className="mx-auto w-full max-w-3xl rounded-4xl border border-blue-200 bg-white p-10 shadow-[0_20px_60px_rgba(37,99,235,0.15)]">
//       <div className="mb-8 text-center">
//         <h2 className="text-3xl font-bold tracking-wide text-blue-600">Login</h2>
//         <p className="text-sm text-slate-500">Sign in to access your WTMS account</p>
//       </div>
...
//         {/* ✅ error comes from store, not local state */}
//         {error && (
//           <div className="rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm font-medium text-red-600">
//             {error}
//           </div>
...
//             <label className="flex cursor-pointer items-center gap-2 text-sm text-slate-500 transition-colors hover:text-slate-700">
//               <input
//                 type="checkbox"
//                 checked={rememberMe}
//                 onChange={(e) => setRememberMe(e.target.checked)}
...
//               type="button"
//               onClick={onSwitchToForgotPassword}
//               className="cursor-pointer text-sm font-medium text-red-500 transition-colors hover:text-red-600 hover:underline"
//             >
//               Forgot password?
//             </button>
//           </div>
...
//         <Button
//           type="submit"
//           disabled={isLoading}           // ✅ isLoading from store
//           className="mt-2 h-12 w-full cursor-pointer rounded-xl bg-blue-600 text-base font-medium shadow-sm transition-all hover:bg-blue-700"
//         >
//           {isLoading ? (
//             <span className="flex items-center justify-center gap-2">
//               <span className="size-5 animate-spin rounded-full border-2 border-white/30 border-t-white" />
...
//         {/* Switch to register */}
//         <div className="cursor-pointer pt-2 text-center text-sm text-slate-500">
//           Don&apos;t have an account?{" "}
//           <button
//             type="button"
//             onClick={onSwitchToRegister}
//             className="cursor-pointer font-semibold text-blue-600 transition-colors hover:text-blue-700 hover:underline"
//           >
//             Register
//           </button>
//         </div>
...
//         <button
//           type="button"
//           className="flex h-12 w-full cursor-pointer items-center justify-center gap-3 rounded-xl border-2 border-slate-200 bg-white text-base font-medium text-slate-400 shadow-sm transition-all hover:bg-slate-50"
//         >
//           <svg viewBox="0 0 24 24" className="size-5">
//             <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4" />
//             <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853" />
